...
<body>
    ...
    <div class="kontak-tentang">
        <a href="#"> <p class="tentang">Tentang Kami</p> </a>
        <a href="#"> <p class="kontak">Kontak Kami</p> </a>
    </div>
